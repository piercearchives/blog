   ...
   <img src={LogoBlog2} alt='Blog' className='icon-l' />
    ...
    <div className='footer__bottom'>
      ...
      <div className='footer__socials'>
        <a href='#facebook' aria-label='Facebook' className='footer__social'><img src={Facebook} alt=''></img></a>
        <a href='#instagram' aria-label='Instagram' className='footer__social'><img src={Instagram} alt=''></img></a>
        <a href='#youtube' aria-label='YouTube' className='footer__social'><img src={Youtube} alt=''></img></a>
        <a href='#twitter' aria-label='Twitter' className='footer__social'><img src={Twitter} alt=''></img></a>
      </div>
    </div>
  </div>
</footer>
